...
@section('content')
    ...
    <div class="block-area " id="alternative-buttons" >
        <h3 class="block-title">Staff Time Sheets List</h3>
         @if(Auth::user()->positionId==2)
        <a class="btn btn-sm hidden" data-toggle="modal" onClick="launchAddDepartmentModal();" data-target=".modalAddDepartment">Activities
        </a>
         @elseif(Auth::user()->positionId==3)
         <a class="btn btn-sm" data-toggle="modal" onClick="launchAddDepartmentModal();" data-target=".modalAddDepartment">Activities
        </a>
          @endif
    </div>
